...
public class Seminar3 {
    ...
    private static void testTaskOne() {
        ...
        MemoryProcess memoryProcess = new MemoryProcess("resources/addresses.txt", memoryManager);
        memoryProcess.callMemory();

        int numberOfPageFaults = memoryManager.getNumberOfPageFaults();
        System.out.println("Number of pages faults: " + numberOfPageFaults);
